...
class PencarianBasecampPage extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  // Di masa mendatang, bagian ini bisa kamu loop memakai ListView.builder dari API Basecamp
                  _buildBasecampCard(
                    namaBasecamp: "Basecamp Patak Banteng",
                    weekday: gunung['weekday'],
                    weekend: gunung['weekend'],
  ...
  // Widget Helper untuk item pilihan Basecamp di bawah deskripsi
